(function ($) {
  function SlickGridPager(dataView, grid, $container) {
    ...
    function constructPagerUI() {
      ...
      $settings
          .append("<span class='slick-pager-settings-expanded' style='display:none'>Show: <a data2=0>All</a><a data2='-1'>Auto</a><a data2=25>25</a><a data2=50>50</a><a data2=100>100</a></span>");

      $settings.find("a[data2]").click(function (e) {
